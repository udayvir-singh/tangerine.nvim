...
local function syn_match(group, pattern)
  _G.assert((nil ~= pattern), "Missing argument pattern on fnl/tangerine/output/logger.fnl:31")
  _G.assert((nil ~= group), "Missing argument group on fnl/tangerine/output/logger.fnl:31")
...
local function parse_title(title)
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:44")
  return (header_block .. title)
end
log["print-success"] = function(title, files)
  _G.assert((nil ~= files), "Missing argument files on fnl/tangerine/output/logger.fnl:48")
...
log["print-failure"] = function(title, file, msg)
  _G.assert((nil ~= msg), "Missing argument msg on fnl/tangerine/output/logger.fnl:54")
  _G.assert((nil ~= file), "Missing argument file on fnl/tangerine/output/logger.fnl:54")
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:54")
  print(parse_title(title))
...
log["float-success"] = function(title, files)
  _G.assert((nil ~= files), "Missing argument files on fnl/tangerine/output/logger.fnl:60")
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:60")
...
log["float-failure"] = function(title, file, msg)
  _G.assert((nil ~= msg), "Missing argument msg on fnl/tangerine/output/logger.fnl:68")
  _G.assert((nil ~= file), "Missing argument file on fnl/tangerine/output/logger.fnl:68")
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:68")
...
log.success = function(title, files, opts)
  _G.assert((nil ~= opts), "Missing argument opts on fnl/tangerine/output/logger.fnl:82")
  _G.assert((nil ~= files), "Missing argument files on fnl/tangerine/output/logger.fnl:82")
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:82")
...
log.failure = function(title, file, msg, opts)
  _G.assert((nil ~= opts), "Missing argument opts on fnl/tangerine/output/logger.fnl:94")
  _G.assert((nil ~= msg), "Missing argument msg on fnl/tangerine/output/logger.fnl:94")
  _G.assert((nil ~= file), "Missing argument file on fnl/tangerine/output/logger.fnl:94")
  _G.assert((nil ~= title), "Missing argument title on fnl/tangerine/output/logger.fnl:94")
  if env.conf(opts, {"compiler", "float"}) then
