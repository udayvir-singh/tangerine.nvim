...
win["create-float"] = function(lineheight0, filetype, hl_normal, _3fhl_border)
  _G.assert((nil ~= hl_normal), "Missing argument hl-normal on fnl/tangerine/utils/window.fnl:148")
...
win["set-float"] = function(lines, filetype, hl_normal, _3fhl_border)
  _G.assert((nil ~= hl_normal), "Missing argument hl-normal on fnl/tangerine/utils/window.fnl:177")
